...
INSERT INTO VIDEO (ID, TITLE, POSTER, VIEWS, DESCRIPTION, ACTIVE) VALUES
                                                                      ('20241103060110', N'Hướng dẫn học lập trình Python cơ bản', 'https://youtu.be/bl2m9eXfm_A?si=SDAMUOUPtFNkl5sF', 120000, N'Khóa học lập trình Python cho người mới bắt đầu', 1),
                                                                      ('20241104073433', N'10 mẹo tăng hiệu suất làm việc với Excel', 'https://youtu.be/UlAxG1PSxME?si=MGMaUBN-dbdma-gB', 85000, N'Trọn bộ các mẹo sử dụng Excel hiệu quả trong công việc', 1),
                                                                      ('20241104120609', N'Chuyến du lịch Sapa cùng gia đình', 'https://youtu.be/8QTZ7GNuwhI?si=aPNmMlFsc16ZS1pk', 54000, N'Video ghi lại chuyến đi Sapa tuyệt đẹp cùng gia đình', 1),
                                                                      ('20241105081427', N'Các cách tối ưu hoá Google Ads', 'https://youtu.be/JptL5SUk-AY?si=5VOpr-DFxkTeKSCL', 20000, N'Tối ưu chi phí và hiệu quả khi sử dụng Google Ads', 1),
                                                                      ('20241106150315', N'Hướng dẫn Photoshop cho người mới', 'https://youtu.be/HdxtcBILnow?si=sD1n0n9miZohW1VS', 99000, N'Bắt đầu với những kỹ thuật cơ bản trong Photoshop', 1),
                                                                      ('20241107182210', N'Giới thiệu Node.js cơ bản', 'https://youtu.be/ysjJlvQ3FFc?si=cOgndJ1EwNYQkO_Q', 67000, N'Khóa học lập trình Node.js cho người mới', 1),
                                                                      ('20241108093320', N'Quy trình phát triển phần mềm Agile', 'https://youtu.be/80PevHArDu8?si=bmhSxR8X8yBl5VhZ', 48000, N'Tìm hiểu về mô hình phát triển Agile', 1),
                                                                      ('20241109020640', N'Thủ thuật sử dụng Google Docs', 'https://youtu.be/tbN5qQEItYc?si=s21DGkQwmmKEeJiI', 52000, N'Thủ thuật giúp làm việc với Google Docs hiệu quả', 1),
                                                                      ('20241110134551', N'Cách viết CV thu hút nhà tuyển dụng', 'https://youtu.be/2fqXC4RQyOw?si=PO_C4GXgFr8Yg_FA', 82000, N'Hướng dẫn viết CV chi tiết và thu hút', 1),
                                                                      ('20241111152344', N'Tìm hiểu về Machine Learning', 'https://youtu.be/5MQxXuuIFxA?si=rDnFIZHFux4CQ7Ut', 43000, N'Giới thiệu về lĩnh vực Machine Learning', 1),
                                                                      ('20241112073818', N'Thế giới động vật kỳ thú', 'https://youtu.be/guZbLg9McEU?si=C83IKGSpRc5vLJNW', 150000, N'Khám phá những điều thú vị về thế giới động vật', 1),
                                                                      ('20241113090314', N'Cuộc sống ở thành phố Tokyo', 'https://youtu.be/p60_w8cEKnU?si=z5ZGIhse0rl2E20q', 61000, N'Trải nghiệm cuộc sống tại Tokyo', 1),
                                                                      ('20241114110630', N'Hướng dẫn sử dụng Canva cho thiết kế', 'https://youtu.be/tQ_H_Noyyng?si=ZhrTuKQvbMgJaHU-', 47000, N'Tạo các thiết kế đơn giản với Canva', 1),
                                                                      ('20241115112719', N'Cách quản lý thời gian hiệu quả', 'https://youtu.be/lk4faynwZ5Q?si=hdCsx_mAIdZ-QrU4', 56000, N'Kỹ năng quản lý thời gian cho học sinh và sinh viên', 1),
                                                                      ('20241116123955', N'Học Tiếng Anh qua bài hát', 'https://youtu.be/UKUzB6LhoYU?si=UlnipuKK4NeOL2ny', 125000, N'Phương pháp học tiếng Anh qua các bài hát', 1),
                                                                      ('20241117071709', N'Sử dụng SQL trong phân tích dữ liệu', 'https://youtu.be/ws0Rgyw36ZY?si=VRsqK10uPkGzONcw', 91000, N'Áp dụng SQL vào phân tích dữ liệu', 1),
                                                                      ('20241118054433', N'Hướng dẫn sử dụng PowerPoint nâng cao', 'https://youtu.be/Yir3qFY1QKY?si=QhCtykvzlJic6CMr', 85000, N'Tạo bài thuyết trình chuyên nghiệp với PowerPoint', 1),
                                                                      ('20241119181921', N'Các bước lập kế hoạch kinh doanh', 'https://youtu.be/86pHHHmUHSY?si=YvUZmVsw6G2oAkNg', 37000, N'Hướng dẫn từng bước để lập kế hoạch kinh doanh', 1),
                                                                      ('20241120041329', N'Tạo dựng kênh YouTube thành công', 'https://youtu.be/rvzs96tPMc0?si=KhZHJO5JZnXLkd5j', 133000, N'Chia sẻ kinh nghiệm phát triển kênh YouTube', 1),
                                                                      ('20241121091422', N'Kỹ năng thuyết trình tự tin', 'https://youtu.be/0DAG8ECDTvw?si=PLeJYs9pGudzzrJ4', 99000, N'Mẹo giúp bạn thuyết trình tự tin và hiệu quả', 1);
...
SELECT * FROM VIDEO V, FAVORITE F WHERE V.ID = F.VIDEOID AND V.ID NOT IN(SELECT VIDEOID FROM FAVORITE)
